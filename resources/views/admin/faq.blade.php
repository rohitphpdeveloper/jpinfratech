      ...
      <div class="container-fluid">
        ...
        <div class="row heading-bg">
          ...
          <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 resolutionbtn">
            <a href="{{url('admin/faq/create')}}" class="btn btn-success btn-anim btn-sm addbtn"><i class="icon-rocket"></i><span class="btn-text">Create Faq</span></a>
          </div>
          <!-- /Breadcrumb -->
        </div>
        <!-- /Title -->
                        ...
                        <tbody>
                         @foreach($faq as $row)
                            <tr>
                                ...
                                <td><a  class="btn btn-success btn-xs" href="{{ url("admin/faq/$row->id/edit") }}"><i class="fa fa-pencil"></i></a>
