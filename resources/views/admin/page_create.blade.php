            ...
            <div class="col-sm-12">
              <div class="panel panel-default card-view">
                <div class="panel-heading">
                  <div class="pull-left">
                    <h6 class="panel-title txt-dark">Create Cms</h6>
                  </div>
                    ...
                    <div class="form-wrap">
                       ...
                       <div class="alert alert-danger">
                        ...
                        @endif
                         ...
                         {!! Form::open(array('url' => 'admin/pages','method' => 'POST','class' => 'form-horizontal form-label-left')) !!}
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12">
                          <input type="text" id="meta_title" name="meta_title" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12">
                          <input type="text" id="name" name="meta_description" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12">
                          <input type="text" id="sort" name="sort"  value="5" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
